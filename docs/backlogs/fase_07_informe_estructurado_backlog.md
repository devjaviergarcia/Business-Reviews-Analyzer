# Backlog FASE_07 - Informe estructurado

- `fase`: `fase_07`
- `documento de fase`: `docs/context/phases/fase_07_informe_estructurado.md`
- `archivo backlog`: `docs/backlogs/fase_07_informe_estructurado_backlog.md`
- `epicas`: `4`
- `tickets`: `12`
...
transformar analisis en informe estructurado con renderer y report-worker

## Contexto y foco de trabajo

Esta fase ataca el siguiente objetivo del roadmap: **transformar analisis en informe estructurado con renderer y report-worker**.

Palabras clave de implementacion/seguimiento: `ReportData, renderer, PDF, Typst, HTML->PDF, report-worker, descarga`.

## Secuencia recomendada

1. Dise̱ar `ReportData` antes del renderer.
2. Separar contenido del layout visual.
3. Integrar report-worker con estados/eventos.

## Criterios de done de la fase

1. esquema de informe versionado
2. renderer v1 genera artefacto real
3. report-worker integrado en pipeline
4. criterios de calidad del informe v1 definidos

## Resumen de epicas

| ID | Epica | Tickets | Resultado esperado |
| --- | --- | ---: | --- |
| `E07-01` | Modelo de datos del informe (`ReportData`) | 3 | La fase 'Informe estructurado' tiene alcance, contratos y validaciones definidos. |
| `E07-02` | Renderer y formato de salida | 3 | Existe una implementacion funcional del bloque principal de la fase 'Informe estructurado'. |
| `E07-03` | Integracion del report-worker y endpoints de informe | 3 | La fase puede operarse con visibilidad y diagnostico suficiente. |
| `E07-04` | Calidad de contenido y utilidad de negocio | 3 | La fase 'Informe estructurado' cierra con criterio objetivo y backlog de siguientes mejoras. |

## Epicas y tickets

### E07-01 - Modelo de datos del informe (`ReportData`)

- `estado sugerido`: `TODO`

**Resultado esperado**

La fase 'Informe estructurado' tiene alcance, contratos y validaciones definidos.

**Objetivo de la epica**

Bajar a contratos y decisiones tecnicas el objetivo de la fase: transformar analisis en informe estructurado con renderer y report-worker.
...
#### T07-001 - Dise̱ar esquema `ReportData` y secciones
...
Especificar que datos entran, que artefactos salen y como se valida el resultado de la fase. Contexto: ReportData, renderer, PDF, Typst, HTML->PDF, report-worker, descarga.
...
#### T07-002 - Implementar mapper analisis -> `ReportData`
...
#### T07-003 - Versionar plantillas de contenido por tipo de informe
...
Registrar los limites esperados de la fase y riesgos principales para Informe estructurado, incluyendo deuda tecnica aceptada temporalmente.
...
### E07-02 - Renderer y formato de salida

- `estado sugerido`: `TODO`

**Resultado esperado**

Existe una implementacion funcional del bloque principal de la fase 'Informe estructurado'.

**Objetivo de la epica**

Construir el nucleo tecnico que materializa la fase: transformar analisis en informe estructurado con renderer y report-worker.
...
#### T07-004 - Comparar Typst vs HTML->PDF y elegir renderer
...
Desarrollar la pieza central de la fase (modulos, servicios, conectores o UI) manteniendo separacion de responsabilidades. Pistas: ReportData, renderer, PDF, Typst, HTML->PDF, report-worker, descarga.
...
#### T07-005 - Implementar renderer v1 y persistencia del artefacto
...
#### T07-006 - Dise̱ar layout visual v1
...
### E07-03 - Integracion del report-worker y endpoints de informe
...
#### T07-007 - Integrar `report-worker` con payloads/estados/eventos
...
#### T07-008 - A̱adir metricas y logs de render
...
#### T07-009 - Exponer endpoints de listado/descarga de informes
...
### E07-04 - Calidad de contenido y utilidad de negocio

- `estado sugerido`: `TODO`

**Resultado esperado**

La fase 'Informe estructurado' cierra con criterio objetivo y backlog de siguientes mejoras.
...
#### T07-010 - Estructurar recomendaciones accionables
...
#### T07-011 - A̱adir metodologia y limitaciones
...
#### T07-012 - Checklist de aceptacion del informe v1
